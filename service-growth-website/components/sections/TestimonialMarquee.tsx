    ...
    <li className="p-8 rounded-2xl border border-white/10 bg-[#1E1E1C] shadow-lg shadow-black/10 max-w-xs w-full select-none">
      <div className="flex gap-0.5 mb-4">
        {Array.from({ length: testimonial.stars ?? 5 }).map((_, i) => (
          <Star key={i} className="w-4 h-4 text-[#E25312] fill-[#E25312]" />
        ))}
      </div>
      ...
      <footer className="flex items-center gap-3">
        <div className="w-9 h-9 rounded-full bg-[#E25312]/20 flex items-center justify-center text-[#E25312] text-sm font-semibold">
  ...
  return (
    <section className="section-dark py-20 md:py-28 px-4 md:px-6 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/10 bg-white/5 text-xs text-[#E25312] mb-6">
            <span className="w-1.5 h-1.5 rounded-full bg-[#E25312] animate-pulse" />
            REAL RESULTS
          </div>
          <h2 className="text-4xl md:text-5xl font-serif text-[#FCFFD5] mb-4">
            Service Businesses That <span className="italic text-[#E25312]">Grew</span>
          </h2>
