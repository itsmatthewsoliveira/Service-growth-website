  ...
  return (
    <div className="min-h-screen bg-[#FCFFD5] relative">
      ...
      <section className="pt-20 pb-10 md:pt-28 md:pb-14 relative overflow-hidden z-10">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[900px] h-[500px] bg-[#FF6A00]/8 rounded-full blur-[140px] pointer-events-none" />
        ...
        <div className="relative max-w-3xl mx-auto px-4 md:px-6 text-center">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white border border-[#121114]/10 shadow-sm mb-6">
            ...
            <h1 className="font-heading text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-[#121114] leading-[1.02] tracking-tight mb-5">
              You&apos;re in,<br />
              <span className="text-[#FF6A00]">{name}</span>.
            </h1>
            <p className="text-[#121114]/60 text-base md:text-lg max-w-xl mx-auto leading-relaxed">
      ...
      <section className="pb-12 relative z-10">
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          ...
          >
            <div className="bg-white border border-[#121114]/[0.08] rounded-2xl p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-5 shadow-[0_1px_3px_rgba(18, 17, 20,0.04),0_20px_60px_-15px_rgba(18, 17, 20,0.12)]">
              <div className="flex items-center gap-4">
                <div className="p-3 rounded-xl bg-[#FF6A00]/10 flex-shrink-0">
                  <Download className="w-5 h-5 text-[#FF6A00]" />
                </div>
                <div>
                  <h3 className="font-heading text-base md:text-lg font-bold text-[#121114] tracking-tight">
                    The 100K Growth Blueprint
                  </h3>
                  <p className="text-[#121114]/50 text-sm">
              ...
              <a
                ...
                className="group flex-shrink-0 flex items-center gap-2 px-6 py-3 rounded-xl bg-[#121114] hover:bg-[#0F0E10] text-[#FCFFD5] font-semibold text-sm transition-all duration-200 shadow-[0_4px_20px_rgba(18, 17, 20,0.15)] hover:shadow-[0_8px_30px_rgba(18, 17, 20,0.25)] hover:-translate-y-0.5"
              >
      ...
      <section className="py-12 border-t border-[#121114]/5 relative z-10">
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            {isHighBudget ? (
              ...
              <div className="space-y-4">
                <div className="relative bg-[#121114] rounded-2xl p-8 md:p-12 text-center overflow-hidden">
                  <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[500px] h-[300px] bg-[#FF6A00]/20 rounded-full blur-[120px] pointer-events-none" />
                  <div className="relative">
                    <div className="p-3 rounded-xl bg-[#FF6A00]/10 w-fit mx-auto mb-5">
                ...
                <div className="bg-white border border-[#121114]/[0.08] rounded-2xl p-6 text-center">
                  <p className="text-[#121114]/60 text-sm mb-1">
                    Not ready for a call? Get on the <span className="text-[#FF6A00] font-semibold">Growth Lab waitlist</span> &mdash; first month free at launch.
                  </p>
                  <p className="text-[#121114]/40 text-xs mb-3">
                  ...
                  {!labSubmitted ? (
                    <form onSubmit={handleLabSignup} className="flex gap-2 max-w-md mx-auto">
                      <input
                        ...
                        className="flex-1 px-4 py-3 rounded-xl bg-[#FCFFD5]/60 border border-[#121114]/10 text-[#121114] placeholder:text-[#121114]/30 focus:outline-none focus:border-[#FF6A00]/50 focus:ring-1 focus:ring-[#FF6A00]/30 text-sm transition-colors"
                      />
                      <button
                        type="submit"
                        disabled={labLoading}
                        className="px-5 py-3 rounded-xl bg-[#121114] text-[#FCFFD5] text-sm font-semibold hover:bg-[#0F0E10] transition-all duration-200 hover:-translate-y-0.5 disabled:opacity-50 disabled:translate-y-0"
                      >
              ...
              <div className="space-y-4">
                <div className="relative bg-[#121114] rounded-2xl p-8 md:p-12 text-center overflow-hidden">
                  ...
                  <div className="relative">
                    ...
                    <h2 style={{ color: "#FCFFD5" }} className="font-heading text-3xl md:text-4xl font-bold tracking-tight leading-[1.05] mb-4">
                      ...
                      <span style={{ color: "#FF6A00" }}>Waitlist</span>
                    </h2>
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-2 mb-7 text-xs">
                      <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#FF6A00]/15 border border-[#FF6A00]/30 text-[#FF6A00] font-semibold">
                    ...
                    {!labSubmitted ? (
                      <form onSubmit={handleLabSignup} className="flex gap-2 max-w-md mx-auto">
                        <input
                          ...
                          value={labEmail}
                          onChange={(e) => setLabEmail(e.target.value)}
                          className="flex-1 px-4 py-3 rounded-xl bg-[#0F0E10] border border-[#FCFFD5]/10 text-[#FCFFD5] placeholder:text-[#FCFFD5]/30 focus:outline-none focus:border-[#FF6A00]/50 focus:ring-1 focus:ring-[#FF6A00]/30 text-sm transition-colors"
                        />
                        <button
                          type="submit"
                          disabled={labLoading}
                          className="group px-6 py-3 rounded-xl bg-[#FF6A00] hover:bg-[#D4804A] text-white font-semibold text-sm transition-all duration-200 shadow-[0_4px_20px_rgba(255, 106, 0,0.3)] hover:shadow-[0_8px_30px_rgba(255, 106, 0,0.4)] hover:-translate-y-0.5 disabled:opacity-50 disabled:translate-y-0"
                        >
                          {labLoading ? "..." : "Join Waitlist"}
                        </button>
                      </form>
                ...
                <div className="bg-white border border-[#121114]/[0.08] rounded-2xl p-6 text-center">
                  <p className="text-[#121114]/60 text-sm mb-3">
                    Already running your business? Let us build the whole system for you.
                  </p>
                  <a
                    href="/contact"
                    className="group inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-[#121114] text-[#FCFFD5] text-sm font-semibold hover:bg-[#0F0E10] transition-all duration-200 hover:-translate-y-0.5"
                  >
                    Book a Strategy Call
                    <ArrowRight className="w-4 h-4 group-hover:translate-x-0.5 transition-transform" />
                  </a>
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-[#121114]/10 border border-[#121114]/10 rounded-2xl overflow-hidden">
            {stats.map((s, i) => (
              ...
              >
                <s.icon className="w-5 h-5 text-[#FF6A00]/70" strokeWidth={1.5} />
                <div>
                  <p className="text-[#121114] font-bold text-3xl md:text-5xl leading-none font-heading tracking-tight mb-2">
                    {s.value}
                  </p>
                  <p className="text-[#121114]/50 text-xs md:text-sm font-medium">{s.label}</p>
                </div>
              </motion.div>
            ))}
          </div>
          <p className="text-center text-[#121114]/40 text-sm mt-8 tracking-tight">
