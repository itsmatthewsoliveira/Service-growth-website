  ...
  return (
    <div className="min-h-screen bg-[#F5F0E8]">
      ...
      <section className="relative pt-24 pb-16 md:pt-32 md:pb-24 overflow-hidden">
        {/* Background glow */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[600px] bg-[#C2703A]/8 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="relative max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold text-[#0C0C0C] leading-[1.1] mb-6">
                The Exact Blueprint We Used to Hit{" "}
                <span className="text-[#C2703A]">$100K in 3 Months</span>
              </h1>

              <p className="text-[#0C0C0C]/60 text-lg md:text-xl mb-8 leading-relaxed">
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                {results.map((r) => (
                  <div
                    key={r.label}
                    className="flex items-center gap-3 p-3 rounded-xl bg-white border border-[#0C0C0C]/10"
                  >
                    <div className="p-2 rounded-lg bg-[#C2703A]/10">
                      <r.icon className="w-4 h-4 text-[#C2703A]" />
                    </div>
                    <div>
                      <p className="text-[#0C0C0C] font-bold text-lg leading-tight">
                        {r.value}
                      </p>
                      <p className="text-[#0C0C0C]/50 text-xs">{r.label}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            >
              {!submitted ? (
                <div className="relative p-8 rounded-2xl bg-white border border-[#0C0C0C]/10 shadow-xl">
                  <div className="absolute inset-0 rounded-2xl bg-gradient-to-b from-[#C2703A]/5 to-transparent pointer-events-none" />

                  <div className="relative">
                    <h2 className="font-heading text-2xl font-bold text-[#0C0C0C] mb-2">
                      Get the Free Blueprint
                    </h2>
                    <p className="text-[#0C0C0C]/50 text-sm mb-6">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          <label className="block text-sm font-medium text-[#0C0C0C]/70 mb-1.5">
                            Your Name
                          </label>
                          <input
                            type="text"
                            ...
                            className="w-full px-4 py-3 rounded-xl bg-[#F5F0E8]/50 border border-[#0C0C0C]/10 text-[#0C0C0C] placeholder:text-[#0C0C0C]/30 focus:outline-none focus:border-[#C2703A]/50 focus:ring-1 focus:ring-[#C2703A]/30 transition-colors"
                          />
                        </div>
                        <div>
                          <label className="block text-sm font-medium text-[#0C0C0C]/70 mb-1.5">
                            ...
                            <button
                              ...
                              className={`p-3 rounded-xl border text-left transition-all ${
                                formData.budget === opt.value
                                  ...
                                  : "border-[#0C0C0C]/10 bg-[#F5F0E8]/50 text-[#0C0C0C]/60 hover:border-[#0C0C0C]/20"
                              }`}
                            >
                      ...
                      <p className="text-center text-[#0C0C0C]/40 text-xs">
                ...
                <motion.div
                  ...
                  className="p-8 rounded-2xl bg-white border border-[#C2703A]/30 text-center shadow-xl"
                >
      ...
      <section className="py-16 md:py-24 border-t border-[#0C0C0C]/5">
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            <h2 className="font-heading text-3xl md:text-4xl font-bold text-[#0C0C0C] mb-4">
              What&apos;s Inside the Blueprint
            </h2>
            <p className="text-[#0C0C0C]/60 text-lg">
          ...
          <div className="space-y-4">
            {blueprintIncludes.map((item, i) => (
              <motion.div
                ...
                className="flex items-start gap-4 p-4 rounded-xl bg-white border border-[#0C0C0C]/10"
              >
                <div className="p-1.5 rounded-lg bg-[#C2703A]/10 mt-0.5">
                  <Check className="w-4 h-4 text-[#C2703A]" />
                </div>
                <p className="text-[#0C0C0C]/80 text-lg">{item}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 md:py-24 border-t border-[#0C0C0C]/5">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-[#0C0C0C]/60 text-lg max-w-2xl mx-auto mb-10">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <motion.div
                  ...
                  className="p-6 rounded-2xl bg-white border border-[#0C0C0C]/10 text-left"
                >
                  <h3 className="font-heading text-lg font-bold text-[#0C0C0C] mb-2">
                    {card.title}
                  </h3>
